...
public:
  ...
  public:
    ...
    typedef int (__stdcall *TInterfaceGetSerialNumber)(long pLLT, char *pSerialNumber, unsigned int nSerialNumberSize);
    ...
    typedef int (__stdcall *TInterfaceTriggerProfile)(long pLLT);
    ...
    typedef int (__stdcall *TInterfaceSaveGlobalParameter)(long pLLT);    
    ...
    TInterfaceGetSerialNumber GetSerialNumber;
    ...
    TInterfaceTriggerProfile TriggerProfile;
    ...
    TInterfaceSaveGlobalParameter SaveGlobalParameter;
